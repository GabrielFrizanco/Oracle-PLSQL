...
/* TABELA FUNCIONARIOS  */
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (1,'ROBERTO MENDES','FORMADO EM ENGENHARIA PELA FUNDAÇÃO ABC','roberto@gmail.com','www.roberto.com.br',to_Date('1971/09/15','YYYY/MM/DD'),20,500,2000,1,1);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (2,'EDSON OLAVO SILVA','ATUA SEMPRE COM COMPETENCIA NAS ATIVIDADES','edson.silva@hotmail.com','www.edsonsilva.com',to_date('1968/06/20','YYYY/MM/DD'),50,505,4000,1,2);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (3,'SIMONE ALMEIDA PRADO','FORMADA PELA FGV','simone@hotmail.com','www.simonedra.com',to_date('1986/08/10','YYYY/MM/DD'),90,525,5000,2,1);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (4,'CARLA SANTOS','EXCELENTE EXECUTIVA','carlinha@hotmail.com','www.carlinha.com',to_Date('1988/03/20','YYYY/MM/DD'),20,538,2000,2,1);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (5,'ROSANGELA BRAVO','CURSANDO ADMINISTRACAO','ro@hotmail.com','www.ro.com',to_date('1980/04/09','YYYY/MM/DD'),10,540,2000,2,3);
